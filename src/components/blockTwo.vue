              ...
              <b-row class="justify-content-center align-items-center" :style=this.fade_style>
                  <img 
                   ...
                   <div style="position: absolute; top: 31%; left: 48%;">
                    <h1 :style="this.leftTextColor(this.combinations[current_progress].target)">
                        {{this.combinations[this.current_progress].p_p.a_first}}
                    </h1>
                  </div>
                  <div style="position: absolute; top: 31%; right: 42%;">
                    <h1 :style="this.rightTextColor(this.combinations[current_progress].target)">
                        {{this.combinations[this.current_progress].p_p.p_first}}
                    </h1>
                  </div>
                  <div style="position: absolute; top: 58%; left: 48%;">
                    <h1 :style="this.leftTextColor(this.combinations[current_progress].target)">
                        {{this.combinations[this.current_progress].p_p.a_second}}
                    </h1>
                  </div>
                  <div style="position: absolute; top: 58%; right: 42%;">
                    <h1 :style="this.rightTextColor(this.combinations[current_progress].target)">
                        {{this.combinations[this.current_progress].p_p.p_second}}
                    </h1>
                  </div>
              </b-row>
          </b-col>
