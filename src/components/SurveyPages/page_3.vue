    ...
    <b-container class="align-bottom" :style="this.windowsize">
      <b-form @submit.prevent>
        <b-form-group
          ...
          label-for="input-2"
        >
          <b-form-select id="input-8" v-model="form.money" :options="money" required></b-form-select>
        </b-form-group>
        <b-form-group
          id="input-group-3"
          label="How likely do you believe in the existence of God, Gods, or something
divine?"
          label-for="input-3"
        >
          <b-form-select
        ...
        <b-form-group
          id="input-group-4"
          label="In general, how do you describe your political views?"
          label-for="input-4"
        >
          <b-form-select id="input-4" v-model="form.political" :options="political" required></b-form-select>
        </b-form-group>
        <b-form-group
          id="input-group-5"
          label="Most people probably view me as…"
          label-for="input-5"
        >
          <b-form-select
            id="input-5"
        ...
        <b-form-group
          id="input-group-6"
          label="Do you spend more time interacting with people that…"
          label-for="input-6"
        >
          <b-form-select id="input-6" v-model="form.interact" :options="interact" required></b-form-select>
        </b-form-group>
        <b-form-group
          id="input-group-7"
