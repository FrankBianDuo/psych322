<template>
  <div class="hello">
    ...
    <p>
      (1) Complete the instructions, (2) experiment 1, (3) the written response section, (4) the survey, and <br />
      (5) send a message to the experimenter with your participant ID and the completion URL at the end. <br />
      Please Ignore Experiments 2 and 3 and never refresh the page. <br />
      You are free to download your data file at the end.
    </p>
