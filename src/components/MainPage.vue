    ...
    processOneResults(raw) {
      ...
      for (i = 0; i < raw.length; i++) {
        ...
        var current = {
          ...
          Response_Combination: this.resp_comb(raw[i].prediction, raw[i].trust),
          ...
          Prediction_Sequence: null,
          Betting_Sequence: null,
          Response_Combination_Sequence: null,
          Control_Rationality: null,
          Subjective_Probability: null,
