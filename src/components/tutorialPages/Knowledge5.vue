<template>
  <b-modal
    ...
    size="xl"
    centered
    title="Instructions Page 29 of 30"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 15.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 16.png')"
    ...
    <b-button
      @click="$bvModal.hide('modal-center-Knowledge5')"
      v-b-modal.modal-center-Knowledge4
      variant="outline-primary"
      size="lg"
    >Back</b-button>
    <b-button
      @click="$bvModal.hide('modal-center-Knowledge5')"
      v-b-modal.modal-center-Knowledge6
      style="float: right;"
      variant="outline-primary"
      size="lg"
    >Next</b-button>
