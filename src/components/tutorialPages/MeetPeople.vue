  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Ref Dependence/Cast of Characters 1.png')"
          v-bind:style="{ maxWidth: '78%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_1, transition: 'opacity 5.0s' }"
        />
        <img
          :src="require('../../assets/Instructions/Ref Dependence/Cast of Characters 2.png')"
          v-bind:style="{ maxWidth: '78%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_2, transition: 'opacity 5.0s' }"
        />
        <img
          :src="require('../../assets/Instructions/Ref Dependence/Cast of Characters 3.png')"
          v-bind:style="{ maxWidth: '78%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_3, transition: 'opacity 0.5s' }"
        />
        <img
          :src="require('../../assets/Instructions/Ref Dependence/Cast of Characters 4.png')"
          v-bind:style="{ maxWidth: '78%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_4, transition: 'opacity 0.5s' }"
        />
      </div>
      <div>
        <b-button
