<template>
    <b-modal 
      ...
      size="xl"
      centered title="Instruction Page 11 of 23"
      :hide-footer="true"
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
        ...
        <b-button style="float: right;" @click="$bvModal.hide('modal-center-MeetPeople')" variant="success" size="lg" v-b-modal.modal-center-WantMoreDots>Next</b-button>
    </b-modal>
</template>
