<template>
  <b-modal
    ...
    size="xl"
    centered
    title="Instructions Page 23 of 30"
    v-model="show"
    :hide-footer="true"
    ...
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        ...
        <img
          ...
          v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_4, transition: 'opacity 1.5s' }"
        />
        <img
...
export default {
  ...
  methods: {
    ...
    animate() {
      ...
      }, 1800); //2800 IN PRODUCTION
      setTimeout(() => {
        parent.opacity_8 = "100%";
        parent.opacity_12 = "100%";
      }, 2200); //2800 IN PRODUCTION
