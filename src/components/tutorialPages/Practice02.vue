<template>
    <b-modal 
      ...
      size="xl"
      centered title="Instruction Page 9 of 23"
      v-model="show"
      :hide-footer="true"
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
          <div style="text-align: center;">
               ...
               <img :src="require('../../assets/Instructions/Machines/Bodies/machine04a.png')" v-bind:style="{ maxWidth: '54%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_7, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Bodies/machine04b.png')" v-bind:style="{ maxWidth: '54%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_8, transition: 'opacity 0.8s' }"/>
               ...
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext14a.png')" v-bind:style="{ maxWidth: '54%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_23, transition: 'opacity 0.4s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext14b.png')" v-bind:style="{ maxWidth: '54%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_24, transition: 'opacity 0.4s' }"/>
               ...
               <!-- Counter -->
               <img :src="require('../../assets/Instructions/Machines/Machine Text/count04.12.png')" v-bind:style="{ maxWidth: '54%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_40, transition: 'opacity 0.2s' }"/>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            animate1() {
                ...
                setTimeout(() => {parent.opacity_19 = "0%"}, 2500);
                setTimeout(() => {parent.opacity_19 = "100%"}, 2600);
                setTimeout(() => {parent.opacity_19 = "0%"}, 2700);
                setTimeout(() => {parent.opacity_18 = "100%"}, 2800);
                setTimeout(() => {parent.opacity_18 = "0%"}, 2900);
                setTimeout(() => {parent.opacity_19 = "100%"}, 3000);
                setTimeout(() => {parent.opacity_19 = "0%"}, 3100);
                setTimeout(() => {parent.opacity_17 = "100%"}, 4000);
                setTimeout(() => {parent.opacity_26 = "100%"}, 4000);
                setTimeout(() => {parent.opacity_29 = "100%"}, 4000);
                setTimeout(() => {parent.opacity_33 = "100%"}, 4000);
                setTimeout(() => {parent.opacity_2 = "100%"}, 4000);
                setTimeout(() => {parent.opacity_4 = "100%"}, 4000);
                ...
                // Text Exchange:
                setTimeout(() => {parent.opacity_23 = "100%"; parent.opacity_24 = "0%"}, 5000);
            ...
            animateJ() {
                ...
                // Text Exchange:
                setTimeout(() => {parent.opacity_23 = "0%"; parent.opacity_24 = "100%"}, 1000);
