  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Moral Choice/Moral Choice 07.png')"
        ...
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd dnlf 5a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd dnlf 5b.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd dnrt 1a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd dnrt 1b.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd uplf 3a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd uplf 3b.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd uprt 5a.png')"
          v-bind:style="{ maxWidth: '90%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_12, transition: 'opacity 0.0s' }"
        />
        <img
          :src="require('../../assets/Instructions/Moral Choice/mcd uprt 5b.png')"
          v-bind:style="{ maxWidth: '90%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_13, transition: 'opacity 0.0s' }"
        />
      </div>
    </b-container>
