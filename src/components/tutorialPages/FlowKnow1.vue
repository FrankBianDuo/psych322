    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
          <div style="text-align: center;">
               ...
               <img :src="require('../../assets/Instructions/FlowKnow/GFaz.png')" v-bind:style="{ maxWidth: '64%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_az, transition: 'opacity 0.0s' }"/>
               
               <!-- opacity 6-10 -->
               <img :src="require('../../assets/Instructions/FlowKnow/GFjk.png')" v-bind:style="{ maxWidth: '64%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_jk, transition: 'opacity 0.0s' }"/>
               ...
               <img :src="require('../../assets/Instructions/FlowKnow/fk text 04a.png')" v-bind:style="{ maxWidth: '64%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_16, transition: 'opacity 0.2s' }"/>
    ...
    export default {
        ...
        methods: {
            ...
            animate0() {
                ...
                setTimeout(() => {this.keyflow1 = true; parent.opacity_presskey = "100%"; }, 3000);
            ...
            animate1() {
                ...
                setTimeout(() => {parent.opacity_az = "100%"}, 1600);
                setTimeout(() => {parent.opacity_az = "0%"}, 1800);
                setTimeout(() => {parent.opacity_az = "100%"}, 2000);
                setTimeout(() => {parent.opacity_az = "0%"}, 2200);
                setTimeout(() => {parent.opacity_az = "100%"}, 2400);
            ...
            animateA() {
                ...
                // Kill key reminder 
                setTimeout(() => {parent.opacity_presskey = "0%"; parent.opacity_az = "0%"; parent.opacity_jk = "0%"; }, 0);

                // Prediction Feedback Up 
                setTimeout(() => {parent.opacity_az = "0%"; parent.opacity_jk = "0%"; parent.opacity_8 = "0%"; parent.opacity_presskey = "0%"; parent.opacity_7 = "100%"; parent.opacity_14 = "0%"}, 0);
                setTimeout(() => {parent.opacity_jk = "100%"; parent.opacity_17 = "100%"}, 1000);
            ...
            animateZ() {
                ...
                setTimeout(() => {parent.opacity_az = "0%"; parent.opacity_jk = "0%"; parent.opacity_7 = "0%"; parent.opacity_presskey = "0%"; parent.opacity_8 = "100%"; parent.opacity_14 = "0%"}, 0);
                setTimeout(() => {parent.opacity_jk = "100%"; parent.opacity_17 = "100%"}, 1000);
            ...
            animateJ() {
                ...
                // Press Space Bar. 
                setTimeout(() => {this.sbc = "outline-secondary"; parent.opacity_presskey = "0%"; }, 0);
                setTimeout(() => {this.keyflow2 = true; this.press = "space bar"; parent.opacity_presskey = "100%"; }, 6000);
                setTimeout(() => {parent.opacity_presskey = "0%"; }, 6500);
                setTimeout(() => {this.sbc = "primary"; parent.opacity_presskey = "100%"; }, 7000); 
            },
            animateK() {
                let parent = this 
                setTimeout(() => parent.mutex = false, 3600); 
            ...
            animate2() {
                ...
                // Press Space Bar. 
                setTimeout(() => {this.sbc = "outline-secondary"; parent.opacity_presskey = "0%"; }, 0);
                setTimeout(() => {this.keyflow3 = true; this.press = "space bar"; parent.opacity_presskey = "100%"; }, 6000);
                setTimeout(() => {parent.opacity_presskey = "0%"; }, 6500);
                setTimeout(() => {this.sbc = "primary"; parent.opacity_presskey = "100%"; }, 7000); 
            },
            animate3() {
                ...
                // Press Space Bar. 
                setTimeout(() => {this.sbc = "outline-secondary"; parent.opacity_presskey = "0%"; }, 0);
                setTimeout(() => {this.keyflow4 = true; this.press = "space bar"; parent.opacity_presskey = "100%"; }, 6000);
                setTimeout(() => {parent.opacity_presskey = "0%"; }, 6500);
                setTimeout(() => {this.sbc = "primary"; parent.opacity_presskey = "100%"; }, 7000); 
            },
            animate4() {
