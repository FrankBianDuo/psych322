<template>
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
        ...
        <b-button style="float: right;" @click="$bvModal.hide('modal-center-instruction40')" variant="outline-primary" size="lg" v-b-modal.modal-center-instruction49>Next</b-button>
    </b-modal>
</template>
    ...
    export default {
        ...
        methods: { 
            ...
            reset_animation_next() {
                this.$bvModal.hide("modal-center-instruction" + this.page_num)
                this.$bvModal.show("modal-center-instruction" + ((Number(this.page_num) + 9).toString()))
            },
            animate() {
