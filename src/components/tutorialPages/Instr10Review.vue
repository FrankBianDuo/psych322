<template>
  <b-modal
    id="modal-center-Instr10Review"
    size="xl"
    centered
    title="Instruction Page 10 of 10"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        ...
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av05a.png')"
          v-bind:style="{ opacity: this.opacity_avatar05a, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av05b.png')"
          v-bind:style="{ opacity: this.opacity_avatar05b, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        ...
        <!-- Text -->
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text01_keypress.png')"
          v-bind:style="{ opacity: this.opacity_text_keypress, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text02a_morebetter.png')"
          v-bind:style="{ opacity: this.opacity_text_morebetter1, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text02b_morebetter.png')"
          v-bind:style="{ opacity: this.opacity_text_morebetter2, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text03_whoknows.png')"
          v-bind:style="{ opacity: this.opacity_text_whoknows, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text04_beliefs.png')"
          v-bind:style="{ opacity: this.opacity_text_beliefs, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text05_mainpoints.png')"
          v-bind:style="{ opacity: this.opacity_text_mainpoints1, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr10_Review/Review_text06_mainpoints.png')"
          v-bind:style="{ opacity: this.opacity_text_mainpoints2, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      opacity_text_keypress: "100%",
      opacity_text_morebetter1: "0%",
      opacity_text_morebetter2: "0%",
      opacity_text_whoknows: "0%",
      opacity_text_beliefs: "0%",
      opacity_text_mainpoints1: "0%",
      opacity_text_mainpoints2: "0%",
      opacity_text_knowledgeb: "0%",
      opacity_text_remember: "0%",
  ...
  mounted() {
    this.$root.$on("bv::modal::show", (bvEvent, modalId) => {
      ...
      if (modalId != "modal-center-Instr10Review") {
        return;
      }
      if (this.mutex == true) {
        return;
  ...
  methods: {
    reset_animation_back() {
      this.resetAnimation();
      this.$bvModal.show("modal-center-Instr09Practice");
    },
    reset_animation_next() {
      this.resetAnimation();
      this.$bvModal.show("modal-center-BeginTrueFalse");
    },
    resetAnimation() {
      this.$bvModal.hide("modal-center-Instr10Review");

      this.opacity_text_keypress = "100%";
      this.opacity_text_morebetter1 = "0%";
      this.opacity_text_morebetter2 = "0%";
      this.opacity_text_whoknows = "0%";
      this.opacity_text_beliefs = "0%";
      this.opacity_text_mainpoints1 = "0%";
      this.opacity_text_mainpoints2 = "0%";
      this.opacity_text_knowledgeb = "0%";
      this.opacity_text_remember = "0%";
      ...
      this.opacity_avatar05a = "100%";
      this.opacity_avatar05b = "0%";
      ...
      this.opacity_dotstableCpurp5 = "100%";
    ...
    animate1() {
      ...
      // Text swap
      setTimeout(() => {
        parent.opacity_text_keypress = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_morebetter1 = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_morebetter2 = "0%";
      }, 0);
       setTimeout(() => {
        parent.opacity_text_whoknows = "0%";
      }, 0);
       setTimeout(() => {
        parent.opacity_text_beliefs = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_mainpoints1 = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_mainpoints2 = "0%";
      }, 0);
    ...
    animateA() {
      ...
      setTimeout(() => {
        parent.opacity_dotstableKpurp2 = "100%";
        parent.opacity_pressAZ = "0%";
      }, 0);
      setTimeout(() => {
    ...
    animateJ() {
      ...
      setTimeout(() => {
        parent.opacity_text_morebetter1 = "100%";
      }, 3000);
      setTimeout(() => {
        parent.opacity_text_morebetter2 = "100%";
      }, 4000);
       setTimeout(() => {
        parent.opacity_text_whoknows = "0%";
      }, 0);
    ...
    animate2() {
      ...
      setTimeout(() => {
       ...
       setTimeout(() => {
        parent.opacity_text_whoknows = "100%";
      }, 800);
       setTimeout(() => {
        parent.opacity_text_beliefs = "0%";
      }, 0);
    ...
    animate3() {
      ...
      setTimeout(() => {
       ...
       setTimeout(() => {
        parent.opacity_text_beliefs = "100%";
      }, 800);
      setTimeout(() => {
        parent.opacity_text_mainpoints1 = "0%";
      }, 0);
    ...
    animate4() {
      ...
      // Kill Graphics
      setTimeout(() => {
        parent.opacity_room1 = "0%";
        parent.opacity_room2 = "0%";
        parent.opacity_you1 = "0%";
        parent.opacity_you2 = "0%";
        parent.opacity_tablesCD = "0%";
        parent.opacity_tablesAZ = "0%";
        parent.opacity_tableK = "0%";
        parent.opacity_wall2 = "0%";
        parent.opacity_choiceD = "0%";
        parent.opacity_choiceC = "0%";
        parent.opacity_choiceA = "0%";
        parent.opacity_choiceZ = "0%";
        parent.opacity_avatar05a = "0%";
        ...
        parent.opacity_dotstableDpurp1 = "0%";
        parent.opacity_dotstableDpurp3 = "0%";
        parent.opacity_dotstableDpurp5 = "0%";
        parent.opacity_dotstableCblack1 = "0%";
        parent.opacity_dotstableCblack3 = "0%";
        parent.opacity_dotstableCblack5 = "0%";
        parent.opacity_dotstableCpurp1 = "0%";
        parent.opacity_dotstableCpurp3 = "0%";
        parent.opacity_dotstableCpurp5 = "0%";
        parent.opacity_dotstableAblack2 = "0%";
        parent.opacity_dotstableAblack4 = "0%";
        parent.opacity_dotstableApurp1 = "0%";
        parent.opacity_dotstableApurp5 = "0%";
        parent.opacity_dotstableZblack2 = "0%";
        parent.opacity_dotstableZblack4 = "0%";
        parent. opacity_dotstableZpurp1 = "0%";
        parent.opacity_dotstableZpurp5 = "0%";
        parent.opacity_dotstableKpurp2 = "0%";
        parent.opacity_dotstableKpurp3 = "0%";
        parent.opacity_dotstableKpurp4 = "0%";
      }, 0);
      ...
      setTimeout(() => {
        parent.opacity_text_mainpoints1 = "100%";
      }, 1500);
      setTimeout(() => {
        parent.opacity_text_mainpoints2 = "0%";
      }, 0);
    ...
    animate5() {
      ...
      setTimeout(() => {
        parent.opacity_text_mainpoints2 = "100%";
      }, 800);
