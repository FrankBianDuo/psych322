<template>
  <b-modal
    ...
    size="xl"
    centered
    title="Instructions Page 28 of 30"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 12.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 13.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 14.png')"
