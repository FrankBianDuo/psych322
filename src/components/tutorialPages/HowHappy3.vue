<template>
  <b-modal
    ...
    size="xl"
    centered
    title="Instruction Page 5 of 30"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        ...
        <img
          :src="require('../../assets/Instructions/HowHappy/text3a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/HowHappy/text3b.png')"
          v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_11, transition: 'opacity 0.3s' }"
        />
        <img
          :src="require('../../assets/Instructions/HowHappy/text3c.png')"
          v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_12, transition: 'opacity 0.3s' }"
        />
        ...
        <!-- Smile Glow -->
        <img
          :src="require('../../assets/Instructions/HowHappy/Tripple/smileglow.png')"
          v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_31, transition: 'opacity 0.5s' }"
        />
      </div>
    </b-container>
    <b-button
