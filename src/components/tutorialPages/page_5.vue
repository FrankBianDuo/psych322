<template>
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
        ...
        <b-button @click="$bvModal.hide('modal-center-instruction5')" v-b-modal.modal-center-instruction4 variant="outline-primary" size="lg">Back</b-button>
        <b-button style="float: right;" @click="$bvModal.hide('modal-center-instruction5')" variant="outline-primary" size="lg" v-b-modal.modal-center-instruction6>Next</b-button>
    </b-modal>
</template>
