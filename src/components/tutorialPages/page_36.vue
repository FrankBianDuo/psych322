  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require(`../../assets/tutorials/You Don_t Know/YDK 1.png`)"
        ...
        />
        <img
          :src="require(`../../assets/tutorials/You Don_t Know/YDK 4.png`)"
        ...
        <!-- TEXT -->
        <img
          :src="require(`../../assets/tutorials/You Don_t Know/t5.png`)"
          v-bind:style="{ maxWidth: '80%', marginTop: '1%',  height: 'auto', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_t1, transition: 'opacity 0.5s' }"
        />
      </div>
    </b-container>
