<template>
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
        ...
        <b-button @click="$bvModal.hide(`modal-center-instruction15`)" v-b-modal.modal-center-instruction14 variant="outline-primary" size="lg">Back</b-button>
        <b-button @click="$bvModal.hide(`modal-center-instruction15`)" v-b-modal.modal-center-instruction16 style="float: right;" variant="outline-primary" size="lg">Next</b-button>
    </b-modal>
</template>
