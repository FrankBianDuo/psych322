  ...
  >
    <b-container class="bv-example-row" :style="this.windowsize">
      <b-row class="mt-5">
        ...
        >Everyone always prefers more dots.</p>
        <!-- Container -->
        <img
          :src="require('../../assets/tutorials/Dot Holders Six.png')"
      ...
      <div style="position: absolute; margin-top: -50%; width: 100%;">
        ...
        <div>
          <img
            @click="this.animate"
            :src="require('../../assets/tutorials/Flashy Avatar 0001.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.avatar_size, height: 'auto', marginTop: '-38%', opacity: this.show_avatar, transition: 'margin-left 0.5s', marginLeft: this.shift_right1, transform: this.trans_1  }"
          />
          <img
            :src="require('../../assets/tutorials/Flashy Avatar 0002.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.avatar_size, height: 'auto', marginTop: '-20.5%',  marginLeft: this.shift_left, transition: 'margin-left 0.5s', transform: this.trans_2  }"
          />
          <img
            :src="require('../../assets/tutorials/Flashy Avatar 0003.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.avatar_size, height: 'auto', marginTop: '-3%',  marginLeft: this.shift_right2, transform: this.trans_3, transition: 'margin-left 0.5s',}"
          />
          <img
            :src="require('../../assets/tutorials/Frown 05.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.frown_size, height: 'auto', marginTop: '-35.5%',  marginLeft: this.end_right, transition: 'opacity 0.5s', opacity: this.frown_opacity_1,}"
          />
          <img
            :src="require('../../assets/tutorials/Frown 05.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.frown_size, height: 'auto', marginTop: '-17.5%',  marginLeft: this.end_left, transition: 'opacity 0.5s', opacity: this.frown_opacity_2}"
          />
          <img
            :src="require('../../assets/tutorials/Frown 11.png')"
            v-bind:style="{ position: 'absolute', maxWidth: this.frown_size, height: 'auto', marginTop: '-0.2%',  marginLeft: this.end_right, transition: 'opacity 0.5s', opacity: this.frown_opacity_3}"
          />
        </div>
      </div>
    </b-container>
    <b-button
      ...
      v-b-modal.modal-center-instruction2
    ...
    <b-button
      ...
      variant="outline-primary"
      size="lg"
      v-b-modal.modal-center-instruction4
      :disabled="this.locked"
    >Next</b-button>
  </b-modal>
</template>
