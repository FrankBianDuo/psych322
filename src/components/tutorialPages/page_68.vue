<template>
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
         ...
         <b-button @click="$bvModal.hide(`modal-center-instruction68`)" v-b-modal.modal-center-instruction67 variant="outline-primary" :disabled="allowprogress" size="lg">Back</b-button>
        <b-button @click="$bvModal.hide(`modal-center-instruction68`)" v-b-modal.modal-center-EndTF2 style="float: right;" variant="outline-primary" :disabled="allowprogress" size="lg">Next</b-button>
