  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Questions TF/Q18a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Questions TF/Q18b.png')"
    ...
    <b-button
      @click="$bvModal.hide(`modal-center-instruction68`)"
      v-b-modal.modal-center-instruction67
