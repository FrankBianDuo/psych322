<template>
  <b-modal
    id="modal-center-Instr07Psych"
    size="xl"
    centered
    title="Instruction Page 7 of 10"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        ...
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av07a.png')"
          v-bind:style="{ opacity: this.opacity_avatar07a, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av07b.png')"
          v-bind:style="{ opacity: this.opacity_avatar07b, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        ...
        <!-- Text -->
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text01_keypress.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text02_arrangement.png')"
          v-bind:style="{ opacity: this.opacity_text_arrangement, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text03_meaning.png')"
          v-bind:style="{ opacity: this.opacity_text_meaning, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text04a_goaldots.png')"
          v-bind:style="{ opacity: this.opacity_text_goaldots, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text04b_goalpred.png')"
          v-bind:style="{ opacity: this.opacity_text_goalpred, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text04c_goalpsych.png')"
          v-bind:style="{ opacity: this.opacity_text_goalpsych, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text05a_knowledge.png')"
          v-bind:style="{ opacity: this.opacity_text_knowledgea, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text05b_knowledge.png')"
          v-bind:style="{ opacity: this.opacity_text_knowledgeb, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr07_Psych/Psych_text06_remember.png')"
          v-bind:style="{ opacity: this.opacity_text_remember, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      opacity_text_arrangement: "0%",
      opacity_text_meaning: "0%",
      opacity_text_goaldots: "0%",
      opacity_text_goalpred: "0%",
      opacity_text_goalpsych: "0%",
      opacity_text_knowledgea: "0%",
  ...
  mounted() {
    this.$root.$on("bv::modal::show", (bvEvent, modalId) => {
      ...
      if (modalId != "modal-center-Instr07Psych") {
        return;
      }
      if (this.mutex == true) {
        return;
  ...
  methods: {
    reset_animation_back() {
      this.resetAnimation();
      this.$bvModal.show("modal-center-Instr06Betting");
    },
    reset_animation_next() {
      this.resetAnimation();
      this.$bvModal.show("modal-center-Instr08Prudence");
    },
    resetAnimation() {
      this.$bvModal.hide("modal-center-Instr07Psych");

      this.opacity_text_keypress = "100%";
      this.opacity_text_arrangement = "0%";
      this.opacity_text_meaning = "0%";
      this.opacity_text_goaldots = "0%";
      this.opacity_text_goalpred = "0%";
      this.opacity_text_goalpsych = "0%";
      this.opacity_text_knowledgea = "0%";
    ...
    animate1() {
      ...
      setTimeout(() => {
        parent.opacity_text_arrangement = "100%";
      }, 2500);
      setTimeout(() => {
        parent.opacity_text_meaning = "0%";
      }, 0);
       setTimeout(() => {
        parent.opacity_text_goaldots = "0%";
      }, 0);
       setTimeout(() => {
        parent.opacity_text_goalpred = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_goalpsych = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_knowledgea = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_knowledgeb = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_remember = "0%";
      }, 0);
    ...
    animateA() {
      ...
      setTimeout(() => {
        parent.opacity_dotstableKpurp4 = "100%";
        parent.opacity_pressAZ = "0%";
      }, 0);
      setTimeout(() => {
      ...
      setTimeout(() => {
        parent.opacity_text_arrangement = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_meaning = "100%";
      }, 800);
       setTimeout(() => {
        parent.opacity_text_goaldots = "0%";
      }, 0);
    ...
    animateJ() {
      ...
      setTimeout(() => {
       ...
       setTimeout(() => {
        parent.opacity_text_goaldots = "100%";
      }, 3500);
       setTimeout(() => {
        parent.opacity_text_goalpred = "100%";
      }, 5000);
      setTimeout(() => {
        parent.opacity_text_goalpsych = "100%";
      }, 6500);
      setTimeout(() => {
        parent.opacity_text_knowledgea = "0%";
      }, 0);
    ...
    animate2() {
      ...
      setTimeout(() => {
        parent.opacity_text_knowledgea = "100%";
      }, 3000);
      setTimeout(() => {
        parent.opacity_text_knowledgeb = "100%";
      }, 5200);
      setTimeout(() => {
        parent.opacity_text_remember = "0%";
      }, 0);
    ...
    animate3() {
      ...
      setTimeout(() => {
        parent.opacity_text_remember = "100%";
      }, 800);
