  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Questions TF/Q12a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Questions TF/Q12b.png')"
    ...
    <b-button
      @click="$bvModal.hide(`modal-center-instruction62`)"
...
export default {
  ...
  computed: {
    ...
    center_title() {
      return (
        "True or False Question " + (Number(this.page_num) - 50).toString()
      );
    },
  },
  mounted() {
