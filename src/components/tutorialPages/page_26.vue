    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
          <div style="text-align: center;">
               ...
               <img :src="require(`../../assets/tutorials/QuizFull/A${this.q_num}.png`)" v-bind:style="{ maxWidth: '10%', height: 'auto', marginTop: '21.8%', transform: 'translate(-50%, 0) scalex(8) scaleY(6)', position: 'absolute', opacity: this.opacity_a, transition: 'opacity 0.5s' }"/>
            </div>
