  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Questions TF/Q01a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Questions TF/Q01b.png')"
    ...
    <b-button
      @click="$bvModal.hide(`modal-center-instruction20`)"
      v-b-modal.modal-center-TF110
    ...
    <b-button
      @click="$bvModal.hide(`modal-center-instruction20`)"
      v-b-modal.modal-center-instruction21
      style="float: right;"
      variant="outline-primary"
      :disabled="allowprogress"
      size="lg"
