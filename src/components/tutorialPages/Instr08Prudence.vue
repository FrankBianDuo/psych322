<template>
  <b-modal
    id="modal-center-Instr08Prudence"
    size="xl"
    centered
    title="Instruction Page 8 of 10"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        ...
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av17a.png')"
          v-bind:style="{ opacity: this.opacity_avatar17a, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr00_Graphics/Avatars/av17b.png')"
          v-bind:style="{ opacity: this.opacity_avatar17b, transition: 'opacity 0.5s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        ...
        <!-- Text -->
        <img
          :src="require('../../assets/Instructions/Instr08_Prudence/Prudence_text01_keypress.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Instr08_Prudence/Prudence_text02_moderate.png')"
          v-bind:style="{ opacity: this.opacity_text_moderate, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr08_Prudence/Prudence_text03_compare.png')"
          v-bind:style="{ opacity: this.opacity_text_compare, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
        <img
          :src="require('../../assets/Instructions/Instr08_Prudence/Prudence_text04_askyourself.png')"
          v-bind:style="{ opacity: this.opacity_text_askyourself, transition: 'opacity 0.8s', maxWidth: '75%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', }"
        />
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      opacity_text_moderate: "0%",
      opacity_text_compare: "0%",
      opacity_text_askyourself: "0%",
  ...
  mounted() {
    this.$root.$on("bv::modal::show", (bvEvent, modalId) => {
      ...
      if (modalId != "modal-center-Instr08Prudence") {
        return;
      }
      if (this.mutex == true) {
        return;
  ...
  methods: {
    ...
    resetAnimation() {
      this.$bvModal.hide("modal-center-Instr08Prudence");

      this.opacity_text_keypress = "100%";
      this.opacity_text_moderate = "0%";
      this.opacity_text_compare = "0%";
      this.opacity_text_askyourself = "0%";
    ...
    animate1() {
      ...
      setTimeout(() => {
        parent.opacity_text_moderate = "0%";
      }, 0);
      setTimeout(() => {
        parent.opacity_text_compare = "0%";
      }, 0);
       setTimeout(() => {
        parent.opacity_text_askyourself = "0%";
      }, 0);
    ...
    animateA() {
      ...
      setTimeout(() => {
        parent.opacity_text_moderate = "100%";
      }, 800);
      setTimeout(() => {
        parent.opacity_text_compare = "0%";
      }, 0);
    ...
    animateJ() {
      ...
      setTimeout(() => {
        parent.opacity_text_compare = "100%";
      }, 800);
       setTimeout(() => {
        parent.opacity_text_askyourself = "0%";
      }, 0);
    ...
    animate2() {
      ...
      setTimeout(() => {
       ...
       setTimeout(() => {
        parent.opacity_text_askyourself = "100%";
      }, 800);
