    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
          <div style="text-align: center;">
              <img :src="require('../../assets/Instructions/Feedback/Feedback 1.png')" v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_1, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Feedback/Feedback 2.png')" v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_2, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Feedback/Feedback 3.png')" v-bind:style="{ maxWidth: '60%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_3, transition: 'opacity 0.0s' }"/>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            animate() {
                let parent = this
                setTimeout(() => {parent.opacity_1 = "0%"; parent.opacity_2 = "100%" }, 300); 
                setTimeout(() => {parent.opacity_2 = "0%"; parent.opacity_3 = "100%" }, 400); 
                setTimeout(() => {parent.opacity_3 = "0%"; parent.opacity_2 = "100%" }, 500); 
                setTimeout(() => {parent.opacity_2 = "0%"; parent.opacity_3 = "100%" }, 600); 
                setTimeout(() => {parent.opacity_3 = "0%"; parent.opacity_2 = "100%" }, 700); 
                setTimeout(() => {parent.opacity_2 = "0%"; parent.opacity_3 = "100%" }, 800); 
                setTimeout(() => {parent.opacity_3 = "0%"; parent.opacity_2 = "100%" }, 900);
                setTimeout(() => {parent.opacity_2 = "0%"; parent.opacity_3 = "100%" }, 1000); 
                setTimeout(() => {parent.opacity_3 = "0%"; parent.opacity_2 = "100%" }, 1100);
                ...
                setTimeout(() => {parent.finishanimate = false}, 1800);
            },
        },
    }
</script>
