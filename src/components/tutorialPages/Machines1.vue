    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
          <div style="text-align: center;">
               ...
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ThreeMeet.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_1, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch1.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_2, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch2.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_3, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch3.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_4, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch4.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_5, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch5.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_6, transition: 'opacity 0.0s' }"/>
               <img :src="require('../../assets/Instructions/Machines/MeetMachines/ch6.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_7, transition: 'opacity 0.0s' }"/>
               ...
               <!-- Text opacity 14-23 -->
               <img :src="require('../../assets/Instructions/Machines/Machine Text/optionsrg.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_14, transition: 'opacity 1.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext01a.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_15, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext01b.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_16, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext01c.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_17, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext01d.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_18, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext01e.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_19, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext02a.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_20, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext02b.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_21, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/mtext02c.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '0%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_22, transition: 'opacity 0.2s' }"/>
               <img :src="require('../../assets/Instructions/Machines/Machine Text/next1.png')" v-bind:style="{ maxWidth: '44%', height: 'auto', marginTop: '6%', transform: 'translate(-50%, 0)', position: 'absolute', opacity: this.opacity_23, transition: 'opacity 0.2s' }"/>
