  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/Questions TF/Q11a.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/Questions TF/Q11b.png')"
...
export default {
  ...
  methods: {
    reset_animation_back() {
      ...
      this.$bvModal.show(
        "modal-center-instruction" + (Number(this.page_num) - 32).toString()
      );
    },
