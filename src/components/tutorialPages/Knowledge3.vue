<template>
    ...
    >
      <b-container class="align-bottom" :style="this.windowsize"  >
        ...
        <b-button @click="$bvModal.hide(`modal-center-Knowledge3`)" v-b-modal.modal-center-Knowledge2 variant="outline-primary" size="lg">Back</b-button>
        <b-button @click="$bvModal.hide(`modal-center-Knowledge3`)" v-b-modal.modal-center-Knowledge4 style="float: right;" variant="outline-primary" size="lg">Next</b-button>
    </b-modal>
</template>
