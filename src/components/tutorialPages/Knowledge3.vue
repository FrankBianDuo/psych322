<template>
  <b-modal
    ...
    size="xl"
    centered
    title="Instructions Page 27 of 30"
    v-model="show"
    :hide-footer="true"
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <div style="text-align: center;">
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 09.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 10.png')"
        ...
        />
        <img
          :src="require('../../assets/Instructions/They Dont Know/tdk 11.png')"
